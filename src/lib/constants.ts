...
/** Public path for the main product launch video on the landing page. */
export const LANDING_LAUNCH_VIDEO_SRC = "/videos/launch.mp4";

/** Poster image shown before the launch video loads. */
export const LANDING_LAUNCH_VIDEO_POSTER = "/videos/launch-poster.jpg";
...
export const LANDING_VIDEO_SCROLL_RUNWAY_VH = 2.8;
